...
ab -n 10 -v 4 -p data.json -T 'application/json' -H 'Authorization: Bearer 1eE4VjRKAW98zndFae0xwVRMfxW66r3e' http://a11fd71d-e03a-4880-a86f-9f20df18289e.southcentralus.azurecontainer.io/score
